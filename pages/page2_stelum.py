            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Hr(style={"width": "100%"}),
                        html.Div(
                            id="stelum-graph-label-container",
                            ...
                            children=[
                                 ...
                                 dbc.Input(id="stelum-graph-label", placeholder="[name1:label1,name2:label2..] <--> [4G_R0005-core_he_0.01:X(He)_{core}=0.01,...]", style={"height": "100%", "width": "85%"}),
                            ]
                        ),
                        html.Div(
                            id="stelum-graph-color-container",
                            ...
                            children=[
                                 ...
                                 dbc.Input(id="stelum-graph-color", placeholder="[name1:color1,name2:color2..] <--> [4G_R0005-core_he_0.01:rgba(123,3,54,1),...]", style={"height": "100%", "width": "85%"}),
                            ]
                        ),
                        html.Div(
                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        dbc.Input(id="stelum-line-value", placeholder="value or: name:column", style={"height": "15%", "width": "80%","marginBottom":"1vh"}),
